...
def init_database():
    ...
    # Produits d'exemple avec codes simples pour QR/Barcode
    produits_exemple = [
        ('Smartphone Galaxy', 'Électronique', 599.99, 15, 'PHONE001'),
        ('Laptop Dell', 'Électronique', 899.99, 8, 'LAPTOP001'),
        ('Chaise Bureau', 'Mobilier', 149.99, 25, 'CHAIR001'),
        ('Livre Python', 'Librairie', 39.99, 50, 'BOOK001'),
        ('Casque Audio', 'Électronique', 79.99, 30, 'AUDIO001'),
        ('Table Basse', 'Mobilier', 199.99, 12, 'TABLE001'),
        ('Clavier Mécanique', 'Électronique', 129.99, 18, 'KEYBOARD001'),
        ('Souris Gaming', 'Électronique', 49.99, 22, 'MOUSE001'),
        ('Écran 24 pouces', 'Électronique', 299.99, 10, 'SCREEN001'),
        ('Webcam HD', 'Électronique', 89.99, 15, 'WEBCAM001')
    ]
