...
def index():
    ...
    try:
        ...
        # Si erreur avec template, retourner une page simple
        return f"""
        <!DOCTYPE html>
        <html>
        <head>
            ...
            <style>
                ...
                .scanner-btn {{ background: #007bff; color: white; padding: 15px 30px; border: none; border-radius: 5px; font-size: 18px; cursor: pointer; display: block; margin: 20px auto; }}
        ...
        <body>
            <div class="container">
                ...
                <button class="scanner-btn" onclick="location.href='/scanner'">📱 Scanner</button>
                <div class="error">Erreur: {str(e)}</div>
            </div>
        </body>
        </html>
        """
...
def scanner():
    ...
    try:
        ...
        # Si template scanner non trouvé, retourner une page simple
        return f"""
        <!DOCTYPE html>
        <html>
        <head>
            ...
            <style>
                ...
                input {{ padding: 15px; font-size: 18px; width: 300px; border: 2px solid #ddd; border-radius: 5px; }}
        ...
        <body>
            <div class="container">
                ...
                <div class="input-group">
                    <input type="text" id="codeInput" placeholder="Tapez ou scannez le code-barres..." autofocus>
                </div>
                <button onclick="scanCode()">🔍 Rechercher</button>
            ...
            <script>
                function scanCode() {{
                    ...
                    .then(data => {{
                        if (data.success) {{
                            showResult('✅ Produit trouvé: ' + (data.produit ? data.produit.nom : 'Produit'), 'success');
                        }} else {{
...
def test():
    ...
    <body>
        <div class="container">
            ...
            <div class="status">
                🚀 L'application Flask est déployée et fonctionne correctement
            </div>
            <p><strong>Boutique Mobile</strong> - Gestion d'inventaire</p>
            <p>
                <a href="/">🏠 Accueil</a> | 
...
def health():
    ...
    return {'status': 'ok', 'app': 'Boutique Mobile'}, 200
